...
describe('Node Server Request Listener Function', function() {
  it('Should answer GET requests for /room with a 200 status code', function() {
    // This is a fake server request. Normally, the server would provide this,
    // but we want to test our function's behavior totally independent of the server code
    var req = new stubs.request('/rooms/room1', 'GET');
  ...
  it('Should accept posts to /rooms/room1', function() {
    var stubMsg = {
      username: 'Jono',
      message: 'Do my bidding!'
    };
    var req = new stubs.request('/rooms/room1', 'POST', stubMsg);
    var res = new stubs.response();
...
it('Should respond with messages that were previously posted', function() {
    ...
    req = new stubs.request('/rooms/room1', 'GET');
